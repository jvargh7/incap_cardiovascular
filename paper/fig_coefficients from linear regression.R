summary_lm <- read_csv(paste0(path_incap_cardio_folder,"/working/summary_linear regressions.csv"))

source("preprocessing/icpaux01_variable list.R")

pdf(file = paste0(path_incap_cardio_folder,"/figures/fig_coefficients from linear regression.pdf"))
